...
| 🟢 **OpenAI** | `gpt-4.1` · `gpt-4o` · `gpt-4o-mini` · `o3-mini` | [platform.openai.com](https://platform.openai.com/api-keys) |
| 🔵 **Google** | `gemini-2.5-flash` · `gemini-2.5-pro` · `gemini-2.0-flash` | [aistudio.google.com](https://aistudio.google.com/apikey) |
